...
namespace NETCore.DapperKit.Extensions
{
    ...
    public static partial class SqlMapperExtensions
    {
        ...
        /// <summary>
        /// get dapper table name
        /// </summary>
        /// <param name="type"></param>
        /// <param name="formater"></param>
        /// <returns></returns>
        internal static string GetDapperTableName(this Type type, ISqlFormater formater)
        {
            return $"{formater.Left}{GetTableName(type)}{formater.Right}";
        }
